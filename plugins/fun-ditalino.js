...
let handler = async (m, { conn, text }) => {
    ...
    let sequenza = [
        `🤟🏻 entro due dita dentro per *${nomeDestinatario}*...`,
        "🤟🏻 Ci siamo quasi...sta per venire",
        "👋🏻 sta venendo!!"
    ];
    ...
    let resultMessage = `✨ *${nomeDestinatario}* è venuta🥵! Sta gemendo fino a finire la voce! *${elapsedTime}ms*!`;
