...
let handler = async (m, { conn, text }) => {
    ...
    let sequenza = [
        `🤟🏻 faccio un ditalino per *${nomeDestinatario}*...`,
        "🤟🏻 Ci siamo quasi...sto finendo",
        "👋🏻 sta venendo!!"
    ];
    ...
    let resultMessage = `✨ *${nomeDestinatario}* è venuta🥵! e ti sta schizzando come uno scoglio *${elapsedTime}ms*!`;
